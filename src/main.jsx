...
const svgString = `
<svg version="1.1" viewBox="0 0 109.5 124.5" xmlns="http://www.w3.org/2000/svg">
    <style>
        .st0{fill:#95BF47;} .st1{fill:#5E8E3E;} .st2{fill:#FFFFFF;}
    </style>
    <g>
        ...
        <g>
            <path class="st1" d="M94.8,22.9c-0.5,0-9.3-0.2-9.3-0.2s-7.4-7.2-8.1-7.9c-0.3-0.3-0.6-0.4-1-0.5l0,109.7l33.1-8.2c0,0-13.5-91.3-13.6-92C95.8,23.3,95.3,22.9,94.8,22.9z" />
            <path class="st2" d="M58,39.9l-3.8,14.4c0,0-4.3-2-9.4-1.6c-7.5,0.5-7.5,5.2-7.5,6.4c0.4,6.4,17.3,7.8,18.3,22.9c0.7,11.9-6.3,20-16.4,20.6c-12.2,0.8-18.9-6.4-18.9-6.4l2.6-11c0,0,6.7,5.1,12.1,4.7c3.5-0.2,4.8-3.1,4.7-5.1c-0.5-8.4-14.3-7.9-15.2-21.7c-0.7-11.6,6.9-23.4,23.7-24.4C54.7,38.2,58,39.9,58,39.9z" />
        </g>
    </g>
</svg>`;
...
createRoot(document.getElementById('root')).render(
    <StrictMode>
        <HelmetProvider>
            <Helmet>
                <title>SHopify POS | Savdo nuqtasi</title>
